...
class _KategoribarangState extends State<Kategoribarang> {
  ...
  Future<void> _submitData() async {
    ...
    Map<String, dynamic> formData = {
      'nama_barang': _judulBarangController.text,
      'deskripsi': _deskripsiController.text,
      'id_kategori': _selectedKategoriId,
      'qty': _qtyController.text,
      'harga_barang': _hargaController.text,
      'status': _selectedStatus,
      'image': 'https://www.google.com/url?sa=i&url=https%3A%2F%2Fsirv.com%2Fhelp%2Farticles%2Fcustomized-error-images%2F&psig=AOvVaw3Lq7pveWAVsAqruTlkdJIq&ust=1724252849055000&source=images&cd=vfe&opi=89978449&ved=0CBEQjRxqFwoTCOCz7cvsg4gDFQAAAAAdAAAAABAE',
      'action': 'insert_barang'
    };
